...
class State:
    ...
    def addDiskToRod(self, diskNum, rodNum):
        ...
        #assert self.rods and self.rods[rodNums] > diskNum or not self.rods
...
numDisks = int(input("Enter number of disks (must be greater than 0): "))
if numDisks <= 0:
...
ans = input("Do you want to see steps taken in optimal path (Y/N)? ")
if ans.lower()[0] == 'y':
    print (optimalPath)
